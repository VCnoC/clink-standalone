...
from ..parsers.base import ParsedCLIResponse
from .base import AgentOutput, BaseCLIAgent


class GeminiAgent(BaseCLIAgent):
    """Gemini-specific behaviour with error recovery."""
    ...
    def _recover_from_error(
        ...
        *,
        ...
        """Try to recover useful content from Gemini CLI errors."""
        combined = "\n".join(part for part in (stderr, stdout) if part)
        if not combined:
            return None

        # Look for JSON error payload
